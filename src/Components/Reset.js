...
function Reset() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-20 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <Link to="/login">
              ...
              >
                Sign in once the password is reset
              </a>
            </Link>
          </p>
        </div>
        <form className="mt-8 space-y-6" action="/" method="POST">
          ...
          <div className="rounded-md shadow-sm -space-y-px px-3">
            <div>
